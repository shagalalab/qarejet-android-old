...
class MappersTest {
    ...
    private val category1 = Category(0, "category1", "icon_one", "color_one", 1)
    private val category2 = Category(0, "category2", "icon_two", "color_two", 2)
    ...
    private val categoryDbModel1 = CategoryDbModel(0, "category1", "icon_one", "color_one", 1)
    private val categoryDbModel2 = CategoryDbModel(0, "category2", "icon_two", "color_two", 2)
